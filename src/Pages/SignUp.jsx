                ...
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input {...register("photo")} name="name" type="text" placeholder="Photo URL" className="input input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                    ...
                    <p><small>New hare <Link to='/login'>Login an your account</Link></small></p>
                </div>
            </div>
        </div>
    );
